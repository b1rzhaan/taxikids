...
class _DriverHomeScreenState extends State<DriverHomeScreen> {
            ...
            : RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    SectionHeader(
                      next != null ? 'Следующая поездка' : 'Заказы',
                    ),
  ...
  Widget _verificationBanner(String status) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: (rejected ? AppColors.danger : AppColors.brand).withValues(
          alpha: 0.14,
        ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  rejected ? 'Заявка отклонена' : 'Аккаунт на проверке',
                  style: const TextStyle(
                    fontWeight: FontWeight.w800,
                    fontSize: 15,
                  ),
  ...
  Widget _statusCard(bool approved) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(
            on ? Icons.bolt : Icons.bedtime_outlined,
            color: on ? AppColors.onBrand : AppColors.muted,
            size: 26,
          ),
          const SizedBox(width: 12),
          Expanded(
  ...
  Widget _stat(String label, String value, {bool accent = false}) => Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(20),
      border: Border.all(
        color: accent ? AppColors.brand.withValues(alpha: 0.5) : AppColors.line,
      ),
    ),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
